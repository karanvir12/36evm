...
//! Utilities to build a `TestClient` for `node-5ire-runtime`.
...
/// Call executor for `node-5ire-runtime` `TestClient`.
...
pub type Client = client::Client<
	...
	node_5ire_runtime::RuntimeApi,
>;

/// Transaction for node-5ire-runtime.
