...
pub fn compact_code_unwrap() -> &'static [u8] {
	node_5ire_runtime::WASM_BINARY.expect(
...
pub const SPEC_VERSION: u32 = node_5ire_runtime::VERSION.spec_version;

pub const TRANSACTION_VERSION: u32 = node_5ire_runtime::VERSION.transaction_version;
